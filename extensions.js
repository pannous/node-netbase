...
wasm = async(_wasm, imports = {}) => {
  ...
  if(!Object.keys(imports).length) imports =  {
      ...
      env:{DYNAMICTOP_PTR:0,tempDoublePtr:0,ABORT:100,memoryBase:0,tableBase:0,abortStackOverflow:(x=>{throw "stack overflow:"+x}),memory:memory,table:table},
